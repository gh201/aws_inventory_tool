...
class text_formatter:
    ...
    def get_last_usage_string():
        ...
        time_delta_since_last_call = datetime.datetime.now() - text_formatter.last_time_function_called
        text_formatter.last_time_function_called = current_time

        text = text_formatter.time_ago_seconds_to_text(time_delta_since_last_call.seconds) + " ago"
